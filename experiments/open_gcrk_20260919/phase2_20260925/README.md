...
| [`PRIMARY_LITERATURE_SNAPSHOT.json`](PRIMARY_LITERATURE_SNAPSHOT.json) | Versioned primary-source identities, occupied claims, transfer limits, and required controls | Source/claim manifest; no empirical result |
